          ...
          function initPush() {
				...
				{ 
                	...
                	if (device.platform == 'android' || device.platform == 'Android') {
			            pushNotification.register(successHandler, errorHandler, {"senderID":"546084058372","ecb":"onNotification"});		// required!
					}
                }
				catch(err) 
				{ 
    ...
    function getLogo() {
        ...
        $.ajax({
            ...
            success: function (data) {
                var json = jQuery.parseJSON(data);
                if(json == null) {
                      $('#clubimage').append('<img tyle="top:50%;left:50%;height:inherit;width:inherit" src="images/unknown.jpg" align="left">');
