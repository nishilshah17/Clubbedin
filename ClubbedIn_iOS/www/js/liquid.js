		...
		config: {
			 ...
			 */
			 gapi : {
				...
				client_id: "1027210905433-vfrlvpvl026magvahntfar509ddge4vp.apps.googleusercontent.com",
				//client_id: "1027210905433-hl829gldhn134u07eucnabgq7erf2j5f.apps.googleusercontent.com",

				// ## Update this value: The client secret obtained during application registration ##
				client_secret: "cAmq1FFLqn9h7yFzuxc4BLnQ",
				//client_secret: "Hi8ZxcZ55Dw1y2cvwtTQDeYb",

				// or urn:ietf:wg:oauth:2.0:oob
				redirect_uri: "http://localhost",
				//redirect_uri: "https://clubbedin.6te.net/index.html",
